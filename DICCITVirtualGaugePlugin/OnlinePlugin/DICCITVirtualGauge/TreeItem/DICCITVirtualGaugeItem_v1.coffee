...
#         @_ico.set "img/plot3D.png"
        ...
        @add_attr
            ...
            show_field  : new Bool false
            show_mesh   : new Bool true
...
#         #test d'un second champ
#         _field2 = new NodalField @_mesh
#         
#         pos2 = new Lst
#         pos_v2 = { axe_name: "time", axe_value: 1 }
#         pos2.push pos_v2
#         
#         @_np.data._data.push 
#             pos : pos2
